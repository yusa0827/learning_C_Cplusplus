...
public:
    ...
    virtual void virtual_print_number(){
        cout << "MyClassBase : print_public_number() :"  << public_number << endl;
    }
...
public:
    ...
    // virtual は派生クラス派生クラスでも実現はできるのか
    void virtual_print_number(){
        cout << "MyClass : print_public_number() :"  << public_number << endl;
    }
...
int main(){
    ...
    // 002 virtualの使い方
    MyClassBase my_myclassbase_1;
    my_myclassbase_1.virtual_print_number();
    MyClass my_mayclass_1;
    my_mayclass_1.virtual_print_number();
